  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between items-center">
        <span className="text-sm font-mono text-slate-700 dark:text-slate-300">{skill}</span>
        <span className="text-xs text-slate-500 dark:text-slate-500">{currentPercentage}%</span>
      </div>
